    ...
    return ( 
      <div className="w-full relative">
        <div className="p-4 sm:p-12">
          <Head/>
          <SiteHeader/>
          <p className="leading-normal max-w-md mb-4 pt-8 text-lg sm:text-xl">
            Bor i Falkenberg och jobbar som designer & utvecklare på <a target="_blank" className="border-b" href="https://glesys.se">GleSYS</a>.
            Pysslar främst med att vidareutveckla kontrollpanelen GleSYS Cloud. <br/>→ <a target="_blank" className="border-b" href="https://cloud.glesys.com/">https://cloud.glesys.com/</a>
          </p>
          <p className="leading-normal max-w-md mb-4 pt-4 text-lg sm:text-xl">
